...
class MistralProvider extends AbstractApiProvider
{
    ...
    {
        return 'https://api.mistral.ai/v1'; // Mistral base URL
    }
    ...
    protected static function createProviderMetadata(): ProviderMetadata
    {
        $providerMetadataArgs = [
            ...
            RequestAuthenticationMethod::apiKey() // Mistral uses Bearer token
        ];
        // Provider description support was added in 1.2.0.
        if (version_compare(AiClient::VERSION, '1.2.0', '>=')) {
            // For WordPress, we should translate the description.
            if (function_exists('__')) {
                $providerMetadataArgs[] = __('Text generation with Mistral.', 'ai-provider-for-mistral');
            } else {
                $providerMetadataArgs[] = 'Text generation with Mistral.';
            }
        }
