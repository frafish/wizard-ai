...
require_once WIZARD_AI_PATH . 'modules/rag/cron/rag.php';
...
add_action('update_option_wai_rag_cron_enabled', 'wizard_ai_rag_reschedule_cron', 10, 0);
add_action('update_option_wai_rag_cron_frequency', 'wizard_ai_rag_reschedule_cron', 10, 0);

add_action('update_option_wai_rag_embedding_provider', 'wizard_ai_rag_provider_changed', 10, 2);
