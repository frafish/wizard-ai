    ...
    public function wb_ai_skills_page_html() {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const apiUrl = '<?php echo esc_url_raw(rest_url("wizard-blocks/v1/skills")); ?>';
                let skillsData = [];
                ...
                async function loadSkills() {
                    listEl.innerHTML = '<li><?php esc_html_e("Loading...", "wizard-ai"); ?></li>';
                    try {
                ...
                function renderList() {
                    ...
                    if (skillsData.length === 0) {
                        listEl.innerHTML = '<li><em style="color:#666;"><?php esc_html_e("No skills found. Create one!", "wizard-ai"); ?></em></li>';
                    } else {
                ...
                saveBtn.addEventListener('click', async () => {
                    ...
                    saveBtn.innerText = '<?php esc_html_e("Saving...", "wizard-ai"); ?>';
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            alert('<?php esc_html_e("Skill saved successfully!", "wizard-ai"); ?>');
                        } else {
                    ...
                    saveBtn.innerText = '<?php esc_html_e("Save Skill", "wizard-ai"); ?>';
                });

                deleteBtn.addEventListener('click', async () => {
                    if (!confirm('<?php esc_html_e("Are you sure you want to delete this skill?", "wizard-ai"); ?>')) return;
