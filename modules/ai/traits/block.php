...
trait Block {
    ...
    public function add_ai_button_to_submitbox($post) {
        if ($post) {
            ...
            wp_enqueue_script($handle, WIZARD_AI_URL . 'modules/ai/assets/js/block-ai.js', [], '1.0.0', true);
            wp_enqueue_style('wizard-block-ai-style', WIZARD_AI_URL . 'modules/ai/assets/css/block-ai.css', [], '1.0.0');
            wp_localize_script(
                $handle,
                'wizardData',
                [
